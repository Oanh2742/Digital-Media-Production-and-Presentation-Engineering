 ...
 * Thu Jan 06 2022 10:16:18 GMT+0700 (Indochina Time)
...
registerOnClick('Object.8', false, false, [0,1,2], function() {
  playSound(loadMedia_HTML5('./drone.mp3'), false);
}, function() {});
registerOnClick('Sphere', false, false, [0,1,2], function() {
  stopSound(loadMedia_HTML5('./drone.mp3'));
}, function() {});

registerOnClick('Xoay ', false, false, [0,1,2], function() {

  operateAnimation('PLAY', 'dau khi VANG', null, null, 'LoopRepeat', 1,
          function() {}, undefined, false);

      }, function() {});

registerOnClick('Object.4', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'dau khi VANG', null, null, 'AUTO', 1,
          function() {}, undefined, false);

      }, function() {});

registerOnClick('Trai', false, false, [0,1,2], function() {

  operateAnimation('PLAY', 'dau khi.TIM', null, null, 'LoopOnce', 1,
          function() {}, undefined, false);

      }, function() {});

registerOnClick('dau khi VANG', false, false, [0,1,2], function() {
  assignMat('Object.4', 'Material.001');
}, function() {});

registerOnClick('dau khi.TIM', false, false, [0,1,2], function() {
  assignMat('Object.4', 'Material.004');
}, function() {});

registerOnClick('Object.10', false, false, [0,1,2], function() {
  assignMat('Object.4', 'Default OBJ');
}, function() {});
